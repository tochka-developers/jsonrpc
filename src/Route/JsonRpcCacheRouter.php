...
class JsonRpcCacheRouter implements JsonRpcRouterInterface
{
    private JsonRpcRouterInterface $router;
    private CacheInterface $cache;
    
    public function __construct(JsonRpcRouterInterface $router, CacheInterface $cache)
    {
        $this->router = $router;
        $this->cache = $cache;
    }
